...
Iext = input('Enter the value of external current');
...
for i = 1:imax  %Time step             
    for k = 1:t      %Updating all the neurons
        ...
        II(2) = (-2*VV{1,2}(i) + (VV{1,1}(i) + VV{1,4}(i)))/R;
        II(3) = (-2*VV{1,3}(i) + (VV{1,1}(i) + VV{1,5}(i)))/R;
        II(1) = Iext - (((2*VV{1,1}(i)) - ( VV{1,2}(i) + VV{1,3}(i)))/R);
        II(t-1) = (-2*VV{1,t-1}(i) + (VV{1,t}(i)+ VV{1,t-3}(i)))/R;
        II(t) = (-2*VV{1,t}(i) + (VV{1,t-1}(i) + VV{1,t-2}(i)))/R;
        %II(4) = (-2*VV{1,4}(i) + (VV{1,2}(i) + VV{1,t}(i)))/R;
        ...
        netcurrent{1,k}(i) = Jion{1,k}(i) + II(k);
    end 
end
